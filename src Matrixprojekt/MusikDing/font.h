...
{0x00,0x38,0x44,0x44,0x44,0x00},	// 0x63
...
{0x00,0x3D,0x40,0x20,0x7D,0x00},	// 0x81		ü
{0x00,0x38,0x54,0x54,0x55,0x09},	// 0x82
{0x00,0x20,0x55,0x55,0x55,0x78},	// 0x83
{0x00,0x20,0x55,0x54,0x55,0x78},	// 0x84		ä
...
{0x00,0x38,0x45,0x44,0x39,0x00},	// 0x94		ö
...
{0x00,0xFE,0x4A,0x4A,0x34,0x00},	// 0xE1		ß
...
{0, 62, 34,	34,	34, 62},	// 0xE6		PS2 Quadrat		230 extrakram
{0, 34, 20,	8,	20, 34},	// 0xE7		PS2 Kreuz
{0, 28, 34,	34,	34, 28},	// 0xE8		PS2 Kreis
{0, 184, 20, 18, 20, 24},	// 0xE9		PS2 Dreieck
{24, 24, 126, 126, 24, 24},	// 0xEA		PS2 Steuerkreuz
{0, 32, 96, 254, 96, 32},	// 0xEB		Pfeil runter
{0, 8, 12, 254, 12, 8},		// 0xEC		Pfeil hoch
{0, 16, 56, 124, 16, 16},	// 0xED		Pfeil links
{0, 16, 16, 124, 56, 16},	// 0xEE		Pfeil rechts
{62, 62, 28, 28, 8, 8},		// 0xEF		PS2 Start
{126, 0, 0, 0, 0, 0},	// 0xF0	Block für Progressbar
{126, 126, 0, 0, 0, 0},	// 0xF1
{126, 126, 126, 0, 0, 0},	// 0xF2
{126, 126, 126, 126, 0, 0},	// 0xF3
{126, 126, 126, 126, 126, 0},	// 0xF4
{126, 126, 126, 126, 126, 126},	// 0xF5
